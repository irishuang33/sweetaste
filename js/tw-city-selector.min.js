! function (t, e) {
	"object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : t.TwCitySelector = e()
}(this, function () {
	"use strict";
	var l = {
	...
	function t() {
		...
		this.options = function () {
				return arguments[1] && function (t, e) {
						var i = "",
							s = e.length;
					...
					function (t, e) {
						...
						var i;
						for (i in t) e[i] = t[i];
						return t.elCountry && (e.elCounty = t.elCountry), t.selectedCountry && (e.selectedCounty = t.selectedCountry), t.countryClassName && (e.countyClassName = t.countryClassName), t.countryFiledName && (e.countyFiledName = t.countryFiledName), e
			...
			function () {
				if (this.options.el) return this.el = s(this.options.el), this.elCounty = s(this.options.elCounty, this.el), this.elDistrict = s(this.options.elDistrict, this.el), this.elZipcode = s(this.options.elZipcode, this.el), i.call(this);
				var t = document.querySelectorAll("[role=" + this.elRoleName + "]");
				return Array.prototype.forEach.call(t, function (t) {
					var e = JSON.parse(JSON.stringify(this));
					return e.el = t, e.elCounty = null, e.elDistrict = null, e.elZipcode = null, e.options.showZipcode = null != t.getAttribute("data-show-zipcode"), i.call(e)
				}, this), t
			}.call(this)
	}
	...
	function i() {
		return function () {
				...
				if (this.elCounty.innerHTML = function () {
						for (var t = '<option value="">選擇縣市</option>', e = function () {
								var t = this.options.only;
								return Array.isArray(t) ? t.map(function (t) {
									var e = t.indexOf("@");
									return -1 === e ? t : t.substring(0, e)
								}) : null
							}.call(this), i = 0, s = l.counties.length; i < s; i++) e && -1 === e.indexOf(l.counties[i]) || (t += '<option value="' + l.counties[i] + '" data-index="' + i + '">' + l.counties[i] + "</option>");
						return t
					}.call(this), this.elCounty.setAttribute("class", this.options.countyClassName), this.elCounty.name = this.options.countyFiledName, !this.elDistrict) {
					var i = document.createElement("select");
					this.elDistrict = i, t.appendChild(i)
				}
				this.options.showDistrict || (this.elDistrict.style.display = "none");
				if (this.elDistrict.innerHTML = n.call(this), this.elDistrict.setAttribute("class", this.options.districtClassName), this.elDistrict.name = this.options.districtFieldName, !this.elZipcode) {
					var s = document.createElement("input");
					this.elZipcode = s, t.appendChild(s), this.elZipcode.style.display = this.options.showZipcode || "none", this.elZipcode.readOnly = !0, this.elZipcode.type = "text", this.elZipcode.placeholder = "郵遞區號", this.elZipcode.name = this.options.zipcodeFieldName, this.elZipcode.setAttribute("class", this.options.zipcodeClassName), this.elZipcode.autocomplete = "off"
				}
			...
			function () {
				var t = function () {
					...
					this.elDistrict.innerHTML = n.call(this, t), this.elZipcode.value = ""
				}.bind(this);
				this.elCounty.addEventListener("change", t)
			}.call(this),
			function () {
				var t = function () {
					var t = this.elDistrict.querySelector("option:checked").dataset.zipcode || "";
					this.elZipcode.value = t + " " + this.elCounty.value + this.elDistrict.value
				}.bind(this);
			...
			function () {
				if (this.options.selectedCounty) {
					...
					t.initEvent("change", !0, !0), this.elCounty.value = this.options.selectedCounty, this.elCounty.dispatchEvent(t)
				}
				this.options.selectedDistrict && (this.elDistrict.value = this.options.selectedDistrict, this.elDistrict.dispatchEvent(t))
			}.call(this), this
	}
	...
	function n(t) {
		...
		for (var e = '<option value="" selected>選擇區域</option>', i = this.elCounty.value, s = function (i) {
				var t = this.options.only;
			...
			}.call(this, i), n = 0, o = l.districts[t][0].length - 1; n <= o; n++) s && -1 === s.indexOf(l.districts[t][0][n]) || (e += '<option value="' + l.districts[t][0][n] + '"\n data-zipcode="' + l.districts[t][1][n] + '"\n >\n\t\t ' + l.districts[t][0][n] + "\n\t\t </option>");
		return e
	}
	return t.prototype.reset = function () {
		return function () {
			return this.elCounty.selectedIndex = 0, this.elDistrict.innerHTML = n.call(this), this.elZipcode.value = "", this
		}.call(this)
	}, t
});